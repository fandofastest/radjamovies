...
public class Dmca extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (JsonUtils.isNetworkAvailable(Dmca.this)) {
            new dmcaTask().execute(config.APP_DET);
        }
    }
            ...
            if (null == result || result.length() == 0) {
                ...
                try {
                    ...
                    for (int i = 0; i < jsonArray.length(); i++) {
                        ...
                        dmcaHtml=objJson.getString(config.DMCA);
                    }
    ...
    public void showToast(String msg) {
        Toast.makeText(Dmca.this, msg, Toast.LENGTH_LONG).show();
    }
