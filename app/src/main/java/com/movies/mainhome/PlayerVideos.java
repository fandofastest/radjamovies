...
public class PlayerVideos extends Activity implements PlaybackControlView.VisibilityListener, View.OnClickListener {
...
//        Toast.makeText(this, "ID url video is : "+url, Toast.LENGTH_SHORT).show();
        init();
...
//        dataSourceFactory.setDefaultRequestProperty("Cookie", incookie);
        ...
        player.addListener(new Player.EventListener() {
            ...
            public void onPlayerError(ExoPlaybackException error) {
                Toast.makeText(PlayerVideos.this, "Sorry for Inconvenience. Please select other server for play movie.", Toast.LENGTH_LONG).show();
